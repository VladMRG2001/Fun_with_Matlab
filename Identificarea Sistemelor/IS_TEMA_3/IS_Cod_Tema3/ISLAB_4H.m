function [a,b,lambda,magi,phii,mag,phi,f] = ISLAB_4H(at,bt,K,N,nr) 
%
% ISLAB_4H   Module that estimates the parameters of an 
...
%
% Explanation:	The parameters of an OE[2,2] model are 
...
a = roots(at) ; 
if (abs(a(1))>=1)
   war_err(['<ISLAB_4H>: Model unstable. ' ...
...
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
u = filter(1,[1 p],u) ; % u este filtrat la 4H
...
for p=1:nr
   ...
   lambda(p) = norm(e)/sqrt(N-4) - 2/3;% Standard deviation.  
% 
