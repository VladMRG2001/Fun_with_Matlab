function [a,b,lambda,magi,phii,mag,phi,f] = ISLAB_4B(at,bt,K,N,nr) 
%
% ISLAB_4B   Module that estimates the parameters of an 
...
a = roots(at) ; 
if (abs(a(1))>=1)
   war_err(['<ISLAB_4B>: Model unstable. ' ...
...
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
u = filter(1,[1 p],u) ; % u este filtrat la 4B
...
for p=1:nr
   ...
   lambda(p) = norm(e)/sqrt(N-2) ;% Standard deviation.  
% 
