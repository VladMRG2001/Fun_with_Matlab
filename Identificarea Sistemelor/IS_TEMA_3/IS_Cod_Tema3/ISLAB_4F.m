...
%
% ISLAB_4F   Module that estimates the parameters of an 
%            OE[1,1] model, with the help of 
...
%
% Explanation:	The parameters of an OE[1,1] model are 
...
a = roots(at) ; 
if (abs(a(1))>=1)
   war_err(['<ISLAB_4F>: Model unstable. ' ...
...
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
u = filter(1,[1 p],u) ; % u este filtrat la 4F 
...
for p=1:nr
   ...
   lambda(p) = norm(e)/sqrt(N-2) - 1/4 ;% Standard deviation.  
% 
