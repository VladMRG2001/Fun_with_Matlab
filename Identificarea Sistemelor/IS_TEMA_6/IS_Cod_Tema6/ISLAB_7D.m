...
disp('Lista celor 6 variante: ');
disp('1 = MCMMP-R cu parametri variabili');
disp('2 = MVI-R cu parametri variabili');
disp('3 = MMEP-R cu parametri variabili');
disp('4 = MRPL-R cu parametri variabili');
disp('5 = CMMP/VI de tip gradient');
disp('6 = CMMP/VI cu filtrare de tip Kalman-Bucy'); 

optiune = input('Alegere varianta: ') ;
...
[D,~,P] = gdata_vp(1,N,sigma,lambda,0) ; 
 ...
 switch optiune
    ...
    case 5
        arx_nabla(N,sigma,lambda) ;
    case 6
        arx_KB(N,sigma,lambda) ;
        
     otherwise
          war_err('comanda introdusa este gresita!') ;
  end
%
% END
%